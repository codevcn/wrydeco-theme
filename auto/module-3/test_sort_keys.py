...
with open("temp_article_sort_test.py", "w", encoding="utf-8") as f:
    f.write(script)

sftp = ssh.open_sftp()
sftp.put("temp_article_sort_test.py", "temp_article_sort_test.py")
sftp.close()

stdin, stdout, stderr = ssh.exec_command("/home/vmadmin/shopify-admin-app/venv/bin/python temp_article_sort_test.py")
