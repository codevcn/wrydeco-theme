"""
upload_images.py:
Script nhận vào đường dẫn thư mục ảnh của 1 sản phẩm cụ thể (ví dụ: `python upload_images.py "media/images/8355804676153"`),
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Upload ảnh từ 1 folder path cụ thể của 1 sản phẩm (ví dụ: `python upload_images.py \"media/images/8355804676153\"`)."
    )
    parser.add_argument(
        "folder_path",
        type=str,
