...
- Bước 4: Hãy đóng vai 1 người thường xuyên đặt hàng online để viết reviews (cho sản phẩm đã đọc được thông tin) vào file `./output/{product_id}-reviews.csv` theo chỉ tiêu đã xác định (chỉ tạo reviews trong file CSV trong folder "output", ko tạo file bên ngoài folder này).
